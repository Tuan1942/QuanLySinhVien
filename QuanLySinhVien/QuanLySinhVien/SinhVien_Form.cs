    ...
    public partial class SinhVien_Form : Form
    {
        ...
        void Sql_Add_Value()
        {
            try
            {
                ...
                command.CommandText = "Insert into " + Form1.Table_name + " values (N'" + mSV.Text +"', N'" + tenSV.Text + "', N'" + namsinh.Text + "', N'" + gioitinh.Text + "', N'" + quequan.Text + "')";
        ...
        void Sql_Change_Value(string Table_name)
        {
            ...
            try
            {
                ...
                connection.Open();
                SqlCommand command = connection.CreateCommand();
                command.CommandText = "Update " + Table_name + " set mSV = N'" + mSV.Text + "', " +
                    "tenSV = N'" + tenSV.Text + "', " +
